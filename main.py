...
This script goes largely unused at this point. It will still work on boards
generated by interactive_solver within a set amount of dimensions, but the 
dimension parameter must be passed into this script in main().
Those dimensions it is confirmed to work on are:
    -5x5
    -6x6

Still useful for seeing CBS solutions on these smaller board sizes.
...
from solvers.sat import solve_puzzle
...
def main():
    # !!@ Set board dims here for accurate solving of TKBoards @!!
    H = 6
    W = 6
    ...
    wait_for_click()
    time.sleep(1)
    # This param is not used - DO NOT TOUCH
    tk_board = False
